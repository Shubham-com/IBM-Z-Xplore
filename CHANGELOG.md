...
- Improved user experience of USS file navigation [#461](https://github.com/zowe/vscode-extension-for-zowe/issues/461). Thanks @stepanzharychevbroadcom
...
- Fixed copying dataset on temporary folder [#635](https://github.com/zowe/vscode-extension-for-zowe/issues/635). Thanks @Colin-Stone
...
- Remove duplicate commands [#376](https://github.com/zowe/vscode-extension-for-zowe/issues/376). Thanks @lauren-li
- Update localization for v1.0.0 [#374](https://github.com/zowe/vscode-extension-for-zowe/issues/374). Thanks @lauren-li
- Update keywords [#383](https://github.com/zowe/vscode-extension-for-zowe/issues/383). @zFernand0
- Update package json files [#391](https://github.com/zowe/vscode-extension-for-zowe/issues/391). @zFernand0
- Fixed adding sessions in Theia [#382](https://github.com/zowe/vscode-extension-for-zowe/issues/382). Thanks @phaumer
- Add validation for undefined username and password + more cosmetic fix [#378](https://github.com/zowe/vscode-extension-for-zowe/issues/378). Thanks @jellypuno
- Update incorrect profile message [#387](https://github.com/zowe/vscode-extension-for-zowe/issues/387). Thanks @lauren-li
